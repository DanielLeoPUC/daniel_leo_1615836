...
},
{
 ...
 "fotos": [
        ...
        },
        {
          ...
          "imagem": "img/atracoes/louvre.jpg"
        },
        {
          "id": 3,
          "nome": "Catedral de Notre-Dame",
          "imagem": "img/atracoes/notre_dame.jpg"
        },
         {
          "id": 4,
          "nome": "Catedral de Notre-Dame",
  ...
  if (obra) {
    telaDetalhes.innerHTML = `
      <div class="col-12 text-center " id="d">
        <img src="${obra.imagem}" alt="${obra.titulo}" width="400px" heigth="400px" class="img-fluid mb-3 p-3">
        <h2>${obra.titulo}</h2>
   ...
   for(let i = 0; i < fotos.length; i++){
      ...
      strTexto += `
       ...
       <article class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3 text-center mt-10 p-2">
        <img src="${fotos[i].imagem}" alt="${fotos[i].autor}" class="img-fluid mb-2">
        <h6>${fotos[i].autor}</h6>
      </article>`;
    }
